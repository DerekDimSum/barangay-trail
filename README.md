...
11. **Score card** — Fiesta Score counts up with tier + "beat ~X%" chip; a win always outscores any loss; **Copy score** flips to "Copied! ✅"; **Ulit tayo!** restarts instantly to the passenger pick (no title screen), while the small "🏠 Balik sa simula" link returns to the title.
